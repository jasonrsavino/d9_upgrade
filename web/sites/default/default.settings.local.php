...
// Docksal DB connection settings for migration source.
if (file_exists($app_root . '/' . $site_path . '/settings.migrations.php')) {
  include $app_root . '/' . $site_path . '/settings.migrations.php';
}
